export const homeData = [
  {
    ...
    rating: 4.9,
    time: "3hr : 10mins",
    desc: "The sequel tells the story of the Sully family — Jake, Neytiri, and their children — as their land becomes torn apart. Per an official synopsis, the Sully family endures danger, battles to the death, and tragedy throughout the film.",
